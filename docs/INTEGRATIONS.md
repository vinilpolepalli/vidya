...
| **Course material** (syllabus page, slides and readings from the LMS, the owner's notes) | read | topics for the semester map; the "from your course material" half of every lesson | downloaded by the Bot after the owner signs in; stored under `~/vidya-state/teach/` | optional |
