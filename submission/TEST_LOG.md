...
| Test | Status | Notes |
|---|---|---|
| T0 fixtures captured | **synthetic: done** / real: ☐ | Synthetic set generated by `vidya/fixtures/build.py`: six courses, day0/day1, five planted changes documented in `expected.json`. Real set: save your six Brightspace pages to `fixtures/real/day0/`, copy to `day1/`, plant five changes, write `expected.json` + `courses.json`, run `vidya selftest --fixtures fixtures/real`. |
