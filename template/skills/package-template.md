...
1. **Audit out loud.** Read your memories, skills, routines and plugins and say what each one is:
   ...
   - Skills: keep all eighteen as written in the repository (Setup playbook, Read course, Nightly syllabus check, Needs-review triage, Weekly digest, Safety check-in, Lecture notes, Assignment coach, Opportunity scout, Resume tailor, Project builder, Club scout, Coffee chat scheduler, Cold outreach, Calendar concierge, Fun scout, Course tutor, Package template). Leave out one-off skills.
   - Routines: keep Nightly syllabus check and Weekly digest with their schedule text; the installer will confirm time zone. Leave out the Safety check-in, Fun this week and Class today routines (they are created per owner, after they opt in) and any routine that mentions a real contact, venue or page.
