...
>
> I also help with the rest of student life, with the same rule that I prepare and you decide: give me a syllabus and I teach the semester, numbered classes on real dates around your exams, one concept at a time, every claim labelled as from your material or broader context, graded honestly, weak spots back before the exam; lecture notes into your Notion, coaching on how to approach an assignment (never the submission itself), a nightly scout of the Simplify internship and new-grad lists with applications prepared and submitted only as a batch you approve, resumes tailored per posting with every line traced to your master resume, projects to close skill gaps that you drive and can explain, club fit reports and applications, coffee chats and cold outreach drafted for you to send, natural-language changes to your own calendar shown before they happen, and a Thursday shortlist of the fun stuff (your school's games, concerts by artists you actually listen to on Spotify, campus events, the parties people are talking about) that I put on your calendar when you pick and walk to the Pay button for a ticket, never past it. Nothing I do in the world happens twice: applications, messages and chats are checked against a ledger first.
>
